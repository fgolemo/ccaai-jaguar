...
# TODO: adjust these
DIRECTORY = os.path.expanduser("~/dev/ccaai-jaguar/mariane-display-server/images")
...
def check_folders():
    ...
    for subfolder in subfolders:
        files += [os.path.join(subfolder,x) for x in os.listdir(subfolder) if FILETYPE in x and not x.startswith(".")]
    return files
